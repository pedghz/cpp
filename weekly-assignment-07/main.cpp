...
// ****************************************************************************
bool registry_alpha (Student first,Student second) { return (first.name < second.name); }
...
// ****************************************************************************
bool pointer_id (Student* first,Student* second) { return ( (*first).id < (*second).id ); }
...
int main() {
    ...
    // ************************************************************************
    std::sort (studentregistry.begin(), studentregistry.end(), registry_alpha);
    ...
    // by the student id.
    // ************************************************************************
    std::sort (studentpointers.begin(), studentpointers.end(), pointer_id);
